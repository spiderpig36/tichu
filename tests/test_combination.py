...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [Card(Color.JADE, 8), Card(Color.SPECIAL, SpecialCard.PHOENIX.value)],
            CombinationType.PAIR,
            8,
            1,
        ),
        (
            [Card(Color.JADE, 7), Card(Color.SWORD, 7), Card(Color.STAR, 7)],
...
@pytest.mark.parametrize(
    "cards",
    [
        [Card(Color.JADE, 8), Card(Color.SWORD, 9)],
        [Card(Color.JADE, 10), Card(Color.SWORD, 10), Card(Color.STAR, 11)],
        [
            Card(Color.JADE, 2),
            Card(Color.SWORD, 4),
            Card(Color.STAR, 5),
        ...
        [Card(Color.SPECIAL, SpecialCard.DOG.value), Card(Color.SWORD, 2)],
        [Card(Color.SPECIAL, SpecialCard.DRAGON.value), Card(Color.SWORD, 14)],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (CombinationType.SINGLE, 9, 1, 8, [Card(Color.SWORD, 8)], False),
        ...
        (
            ...
            1,
            8,
            [Card(Color.JADE, 8), Card(Color.PAGODE, 8), Card(Color.SWORD, 8)],
            True,
        ),
        ...
        (
            ...
            1,
            9,
            [Card(Color.JADE, 9), Card(Color.PAGODE, 9), Card(Color.SWORD, 9)],
            False,
        ),
